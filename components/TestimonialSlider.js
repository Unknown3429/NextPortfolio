      ...
      return (
        <SwiperSlide key={i}>
          <div className='flex flex-col items-center md:flex-row gap-x-8 h-full px-16 '>
            ...
            {/* quote  */}
            <div className='flex-1 flex flex-col justify-center before:w-[1px] xl:before:bg-white/20 xl:before:absolute xl:pl-20 xl:before:left-0 xl:before:h-[200px] xl:before:mr-5 relative'>
              {/* icon  */}
              <div className='mb-4'>
